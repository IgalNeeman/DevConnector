...
const CreateProfile = props => {
 ...
 // come from create-profile.html
 //part 47- Create Profile Component
    ...
    return (
      ...
      <form className="form">
        ...
        <div className="form-group social-input">
          ...
          <input type="text" placeholder="Instagram URL" name="instagram" value={instegram} onChange={e=> onChange(e)} />
        </div>
                   </Fragment>}     
